...
export function dispatch(
  ...
  // The repo comes from jobRepo() — the same resolver executeCloud launches with — so the
  // cursor-cloud GitHub/delivery=pr gate judges exactly the repo the launch will use.
  const dispatchRepo = jobRepo(job);
