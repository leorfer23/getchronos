...
import { startHostFailover } from "./host-failover.js";
...
import { startFollowUps } from "./jot-followup.js";
...
// …and when one of those computers stays gone past the grace, its terminals move to one that is here.
startHostFailover();
